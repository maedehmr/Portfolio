  ...
  <div className=" flex justify-center items-center">
    ...
    >
      <input
        ...
        required
        className="p-2 bg-transparent border-2 border-slate-500 rounded-md text-slate-800 focus:outline-none"
      />
      <input
        type="email"
        name="email"
        ...
        required
        className="my-4 p-2 bg-transparent border-2 border-slate-500 rounded-md text-slate-800 focus:outline-none"
      />
      <textarea
        name="message"
